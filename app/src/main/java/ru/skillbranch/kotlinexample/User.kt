...
class User private constructor(
    ...
    constructor(
        ...
        when {
            ...
            else -> throw java.lang.IllegalArgumentException("Email or phone must be not blank")
        }
    }
    ...
    fun changePassword(oldPass: String, newPass: String) {
        ...
        else throw IllegalArgumentException("The entered password does not math the current password")
    }
    ...
    companion object Factory {
        ...
        fun importUser(
            ...
            val (firstName, lastName) = fullName.fullNameToPair()
            return User(firstName, lastName, email, rawPhone, password, salt)
        }
            ...
            return this.trim().split(" ")
                ...
                .run {
                    when (size) {
                        1 -> first() to null
                        2 -> first() to last()
                        else -> throw IllegalArgumentException("FullName must contain only first name amd last name, current split result ${this@fullNameToPair}")
                    }
                }
        }
    }
